...
-- first_setup moved to dedicated healthcheck table
('website_description', 'This is my website.');
...
--- Create healthcheck table (moved from settings.first_setup)
...
-- insert default healthcheck row (previously in settings)
insert into public.healthcheck (first_setup) values
(true);
